...
set ::GLOBAL_hps_sdram_p0_io_standard "1.2-V HSUL"
set ::GLOBAL_hps_sdram_p0_io_interface_type "HPAD"
set ::GLOBAL_hps_sdram_p0_io_standard_differential "1.2-V HSUL"
...
set ::GLOBAL_hps_sdram_p0_uniphy_temp_ver_code 1835141422
# PLL Parameters
...
set ::GLOBAL_hps_sdram_p0_pll_mult(0) 293
set ::GLOBAL_hps_sdram_p0_pll_div(0) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(0) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_AFI_CLK) 293
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_AFI_CLK) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(PLL_AFI_CLK) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(1) 293
set ::GLOBAL_hps_sdram_p0_pll_div(1) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(1) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_MEM_CLK) 293
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_MEM_CLK) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(PLL_MEM_CLK) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(2) 293
set ::GLOBAL_hps_sdram_p0_pll_div(2) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(2) 270.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_WRITE_CLK) 293
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_WRITE_CLK) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(PLL_WRITE_CLK) 270.0
set ::GLOBAL_hps_sdram_p0_pll_mult(3) 293
set ::GLOBAL_hps_sdram_p0_pll_div(3) 22
set ::GLOBAL_hps_sdram_p0_pll_phase(3) 270.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_ADDR_CMD_CLK) 293
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_ADDR_CMD_CLK) 22
