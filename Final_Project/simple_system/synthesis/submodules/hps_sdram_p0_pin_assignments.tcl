...
foreach inst $instances {
	...
	foreach dq_pin $pins(all_dq_pins) {
		...
		set_instance_assignment -name OUTPUT_TERMINATION "SERIES 34 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_hps_sdram_p0_corename
	}
	...
	foreach dqs_pin [ concat $pins(dqs_pins) $pins(dqsn_pins) ] {
		...
		set_instance_assignment -name OUTPUT_TERMINATION "SERIES 34 OHM WITH CALIBRATION" -to $dqs_pin -tag __$::GLOBAL_hps_sdram_p0_corename
	}

	set termination_atom_name [hps_sdram_p0_get_termination_atom_name $inst]

	foreach ck_pin [ concat $pins(ck_pins) $pins(ckn_pins) ] {
		set_instance_assignment -name D5_DELAY 3 -to $ck_pin -tag __$::GLOBAL_hps_sdram_p0_corename
		...
		set_instance_assignment -name OUTPUT_TERMINATION "SERIES 34 OHM WITH CALIBRATION" -to $ck_pin -tag __$::GLOBAL_hps_sdram_p0_corename
		set_instance_assignment -name TERMINATION_CONTROL_BLOCK "$termination_atom_name" -to $ck_pin -tag __$::GLOBAL_hps_sdram_p0_corename
	}
	...
	foreach ac_pin $pins(ac_pins) {
		...
		set_instance_assignment -name OUTPUT_TERMINATION "SERIES 34 OHM WITH CALIBRATION" -to $ac_pin -tag __$::GLOBAL_hps_sdram_p0_corename
		set_instance_assignment -name TERMINATION_CONTROL_BLOCK "$termination_atom_name" -to $ac_pin -tag __$::GLOBAL_hps_sdram_p0_corename
	}
	...
	foreach dm_pin $pins(dm_pins) {
		...
		set_instance_assignment -name OUTPUT_TERMINATION "SERIES 34 OHM WITH CALIBRATION" -to $dm_pin -tag __$::GLOBAL_hps_sdram_p0_corename
	}
